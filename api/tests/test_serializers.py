...
class FishSerializerTest(TestCase):
    ...
    def test_serializer_output(self):
        ...
        self.assertIn("Move into inlets during winter.", data['trends'])  # Trends as strings
        self.assertIn("Use live bait near structure.", data['techniques'])  # Techniques as strings
